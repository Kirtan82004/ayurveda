...
Payment ID: ${paymentMode === "COD" ? "N/A" : paymentId}
...
`;
  ...
  paymentId: string = "N/A") => {
    ...
    const status = paymentMode === "COD" ? "PENDING" : "PAID";
                ...
                <Card className="p-6 border border-border sticky top-24">
                  ...
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      size="lg"
                      variant="outline"
                      className="w-full disabled:* border-primary text-primary font-bold"
                    >
                      💳 Pay Now
                    </Button>
                    <Button
