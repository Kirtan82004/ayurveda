...
const BLOG_TIPS = [
  {
    ...
    link: '/blog/customer-reviews-testimonials',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhcXwvq9f8BiBepTfa5FxP3n',
  },
  {
    ...
    link: '/blog/ayurvedic-daily-routine-lifestyle',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhcexR8s1XPu371dZzB07m89',
  },
  {
    ...
    link: '/blog/immunity-digestion-internal-wellness',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhcquOrdVW-aVfKpjNW5_eGy',
  },
  {
    ...
    link: '/blog/healthy-weight-management-body-balance',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhcmYWNoMKYE0fs_vCH-JxQ5',
  },
  {
    ...
    link: '/blog/natural-skin-hair-beauty-care',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhdqIYaFSrYqvOL1jACwqJL4',
  },
  {
    ...
    link: '/blog/mens-womens-wellness-support',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhfZybkpzJxq1yQ2fngcxtl4',
  },
  {
    ...
    link: '/blog/detox-stress-relief-mental-wellness',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkheffsP9gl22OiLr_7l7mm7c',
  },
  {
    ...
    link: '/blog/seasonal-ayurveda-home-remedies',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhcCLs7pp9yH7HpIxATyxWc2',
  },
  {
    ...
    link: '/blog/ayurvedic-herbs-ingredient-education',
    youtube:
      'https://www.youtube.com/playlist?list=PL8ONJ3g-KkhdCv7TnjviCtBzkDO1KaRtB',
  },
];
...
<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
  {BLOG_TIPS.map((tip, index) => (
    <Link
      ...
      className="group"
    >
      <Card className="p-6 border border-border hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer h-full flex flex-col justify-between">

        <div>
          <h3 className="text-xl font-serif font-bold group-hover:text-primary transition-colors mb-3">
            {tip.title}
          </h3>

          <span className="text-foreground/80 text-sm leading-7 block">
            {tip.description}
          </span>
        </div>
        ...
        <div className="mt-5 flex items-center justify-between gap-3">
          ...
          <a
            ...
            className="text-xs text-foreground/70 hover:text-primary transition"
          >
            Watch Playlist
          </a>
