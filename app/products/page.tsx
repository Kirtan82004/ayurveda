...
const CATEGORIES = ['All', 'Immunity', 'Skin', 'Hair', 'Digestion'];
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex gap-8">
              ...
              <Link href="/products" className="text-foreground hover:text-primary transition font-semibold">Products</Link>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-secondary border-b border-border">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-foreground/70">Explore our curated selection of authentic Ayurvedic products</p>
        </div>
      </section>
