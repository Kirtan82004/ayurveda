          ...
          <div className="prose prose-invert max-w-none space-y-6">
            <Card className="p-6 border border-border">
              ...
              <p className="mt-1 text-foreground/80">
                ...
                prevent any disease, <span className='text-black'>as defined under Indian laws.</span>
              </p>
            </Card>

            <Card className="p-6 border border-border">
              <h2 className="text-2xl font-serif font-bold text-foreground">Regulatory Compliance</h2>
              <ul className="space-b-2 text-foreground/80">
            ...
            <Card className="p-6 border border-border">
              <h2 className="text-2xl font-serif font-bold text-foreground">Medical Advice Disclaimer</h2>
              <p className="text-foreground/80">
                Ayurvedic results vary from person to person based on body type, diet, lifestyle, medical conditions, and consistency of use.
              </p>

              <p className="text-foreground/80">Please <span className="font-bold">consult a qualified medical practitioner</span> before using our products if you are: </p>
              <ul className='ml-2.5'>
            ...
            <Card className="p-6 border border-border">
              ...
              <p className=" text-foreground/80">If you are dissatisfied with any part of our website or information, your only remedy is to
            ...
            <Card className="p-6 border border-border">
              ...
              <ul>
                <li className="text-foreground/80 m-0" >This Disclaimer and all related matters are governed by the laws of{" "}
                <span className="font-bold">India</span>.</li>
                <li className="text-foreground/80 m-0"> In case of disputes, claims, or legal proceedings, the jurisdiction will
                exclusively lie with the Courts of Delhi, India.</li>
              </ul>
            </Card>
            ...
            <Card className="p-6 border border-border">
              <h2 className="text-2xl font-serif font-bold text-foreground">Legal Policies Overview</h2>
              <p className="text-foreground/80">
                Below are short summaries for users who want a quick glance at our legal structure.
              </p>
              <h3 className="text-xl font-serif font-bold text-foreground">Privacy Policy (Brief)</h3>
              <p className="text-foreground/80">
              ...
              <h3 className="text-xl font-serif font-bold text-foreground">Terms of Service (Brief)</h3>
              ...
              <h3 className="text-xl font-serif font-bold text-foreground">Return, Refund & Shipping Policies</h3>
              <p className="text-foreground/80">
